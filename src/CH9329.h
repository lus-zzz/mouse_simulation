...
class CH9329 {
private:
    QSharedPointer<QSerialPort> _serial;
    uint8_t _addr;
...
public:
    CH9329(QString serial , uint32_t _baud  = 9600, uint8_t addr = 0x00);
    ~CH9329();
    ...
    void mouseRelease();
    void mouseMove( uint16_t horizontal , uint16_t vertical , uint8_t ms_key = 0);
